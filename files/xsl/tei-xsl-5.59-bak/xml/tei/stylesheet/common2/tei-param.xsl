...
<xsl:stylesheet xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:m="http://www.w3.org/1998/Math/MathML" xmlns:="http://www.-c.org/ns/1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="m  xsi sch" version="1.0">
  <doc xmlns="http://www.oxygenxml.com/ns/doc/xsl" scope="stylesheet" type="stylesheet">
    <desc>
      <p> stylesheet customization module, common for all output
      formats.</p>
      ...
      <p>Id: $Id: -param.xsl 9408 2011-09-27 20:09:13Z rahtz $</p>
  ...
  <xsl:template name="autoMakeHead">
    ...
    <xsl:choose>
      <xsl:when test="head and $display='full'">
      ...
      <xsl:when test="front/head">
        <xsl:apply-templates select="front/head" mode="plain"/>
      </xsl:when>
      <xsl:when test="@n">
  ...
  <xsl:param name="homeURL">http://www.-c.org/</xsl:param>
  <doc xmlns="http://www.oxygenxml.com/ns/doc/xsl" class="links" type="string">
    <desc>Project</desc>
  </doc>
  ...
  <xsl:param name="institution">A  Project</xsl:param>
  <doc xmlns="http://www.oxygenxml.com/ns/doc/xsl" class="links" type="anyURI">
    <desc> Institution link</desc>
  </doc>
  <xsl:param name="parentURL">http://www.-c.org/</xsl:param>
  <doc xmlns="http://www.oxygenxml.com/ns/doc/xsl" class="links" type="string">
  ...
  <xsl:template name="numberBackDiv">
    <xsl:if test="not($numberBackHeadings='')">
      <xsl:number count="div|div1|div2|div3|div4|div5|div6" format="A.1.1.1.1.1" level="multiple"/>
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template name="numberBodyDiv">
    <xsl:if test="$numberHeadings='true'">
      <xsl:number count="div|div1|div2|div3|div4|div5|div6" level="multiple"/>
    </xsl:if>
  </xsl:template>
  <doc xmlns="http://www.oxygenxml.com/ns/doc/xsl" class="numbering" type="string">
    <desc> How to construct heading numbering in
