...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml" 
  ...
  <doc xmlns="http://www.oxygenxml.com/ns/doc/xsl" scope="stylesheet" type="stylesheet">
      ...
      Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA 02111-1307 USA </p>
         ...
         <p>Id: $Id: header.xsl 9585 2011-11-02 22:48:48Z rahtz $</p>
  ...
  <xsl:key name="ALL-LOCALRENDITION" match="rendition" use='1'/>
  ...
  <xsl:template match="availability"  mode="copyrighttext">
    <xsl:apply-templates mode="copyrighttext"/>
  </xsl:template>

  <xsl:template match="licence"  mode="copyrighttext">
    <xsl:if test="@target">
      <xsl:text>[</xsl:text>
