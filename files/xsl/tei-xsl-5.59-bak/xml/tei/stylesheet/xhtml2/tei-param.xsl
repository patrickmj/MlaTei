...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"                 
  ...
  <doc xmlns="http://www.oxygenxml.com/ns/doc/xsl" scope="stylesheet" type="stylesheet">
    ...
    Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA
         ...
         <p>Id: $Id: tei-param.xsl 9513 2011-10-17 08:55:51Z rahtz $</p>
         <p>Copyright: 2011, TEI Consortium</p>
      </desc>
   </doc>
  <xsl:key name="INDEX" use="1" match="index"/>
  <xsl:key name="PB" match="pb" use="1"/>
  <xsl:key name="NOTES" use="1"
	   match="note[@place='foot' or @place='bottom' or @place='end'
		  and not(parent::bibl or ancestor::teiHeader)]"/>
  <xsl:key name="ALLNOTES" use="1"
	   match="note[not(@place='margin' or @place='inline' or @place='display')
		  and not(parent::bibl or  ancestor::teiHeader)]"/>

  <xsl:key name="TAGREND" match="tagUsage[@render]" use="@gi"/>
...
all.
  ...
  <xsl:param name="standardSuffix">
      <xsl:choose>
         <xsl:when test="teiCorpus">.html</xsl:when>
